...
PARTNERS = {
    ...
    -1: {  # TODO: replace key with real res_id when known (Bria)
        "name": "Bria",
        "grade": 5,
        "class": "Psionic",
    ...
    -2: {  # TODO: replace key with real res_id when known (Janet)
        "name": "Janet",
        "grade": 5,
        "class": "Hunter",
    ...
    -3: {  # TODO: replace key with real res_id when known (Marianne)
        "name": "Marianne",
        "grade": 5,
        "class": "Striker",
    ...
    -4: {  # TODO: replace key with real res_id when known (Scarlet)
        "name": "Scarlet",
        "grade": 5,
        "class": "Striker",
