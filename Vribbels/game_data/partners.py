...
PARTNERS = {
    ...
    20014: {
        ...
        "stats_conditional": {
            "CRate": (8, 10, 12, 14, 16),  # Only assigned Combatant's Attack Cards
            "CDmg": (15, 17.5, 20, 22.5, 25),  # After a Critical hit of assigned Combatant (5 stacks / max 5 stacks)
        },
    ...
    30085: {
        ...
        "stats_conditional": {
            "CRate": (6, 8, 9, 11, 12),  # After the assigned Combatant activates both Shield gain and Heal using Order Cards (for 1 turn)
        },
    ...
    30053: {
        ...
        "stats_conditional": {
            "CDmg": (20, 28, 32, 36, 40),  # After a Passion Quietus card of the assigned Combatant is Discarded (4 stacks / max 4 stacks)
        },
    ...
    30094: {
        ...
        "stats_conditional": {
            "CDmg": (20, 28, 32, 36, 40),  # After assigned Combatant's Linked cards are used manually or Discarded 3 times.
                                           # Also +10/+20 from Ego Skill? Not sure if Ego skills should be counted or not...
        },
        "ego_name": "Field Overview",  # this # TBD
        "ego_cost": 2,
    ...
    1070: {
        ...
        "stats_conditional": {
            "CDmg": (20, 28, 32, 36, 40),  # After a Basic Attack Card is activated (4 stacks / max 4 stacks)
        },
    ...
    30092: {
        ...
        "stats_conditional": {
            "CDmg": (20, 25, 30, 35, 40),  # When 5 or more Void Attack Cards are created in the Draw Pile
        },
        "ego_name": "Incense",
        "ego_cost": 3,
