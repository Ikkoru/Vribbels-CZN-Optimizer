...
- **Sortie Stats and Great Rift Stats**, under the gacha sheet. The Sortie's: total clears and the highest Difficulty cleared, then each season's rank out of everyone ranked, as a top percentage, with your best score and the season's top score; a finished season shows its final rank. The Great Rift's: each half's subdivision and the top percentage the game gives it, your best score, and for the half still running your rank against an estimate of the whole field, which is more exact than the subdivision's percentage. Under that half, Master I's best score and the best score in your own division. Open Hardcore Rankings and Merit Ranking while capturing to fill them. The newest four seasons of each are shown.
