...
- **Sortie Stats, Great Rift Stats and Full-Scale Offensive Stats**, beside the gacha sheet: a column per season, newest first, scrolling sideways once there are more than fit. The Sortie's: your top percentage, rank, out of how many, your best score and the season's top score; a finished season shows its final rank once Previous Sortie Ranking has been opened. The Great Rift's, a column per half: your place in the whole field, estimated from the division tops and more exact than the percentage the game gives your subdivision, then that percentage, your rank, the field's size, your best score, Master I's best score and the best in your own division. The Full-Scale Offensive's: its percentage, rank, field and your total score. The note beside each title says what to open while capturing.
